"""
tests the generated files of some specific tiles which has caused various issues historically
"""
...
class TestSpecificTiles(unittest.TestCase):
    """
    ...
    def test_calc_output_netherlands(self):
        """
        Test output of countries without border countries
        - of malta
        """
        # run tool for country
        self.run_wahoomapscreator_cli('131','84')
...
#        self.compare_dir_sub_test_resource_and_output('137', 'malta')
    ...
    def test_calc_output_norway_tile_hanging_due_to_process_open(self):
        """
        Test output of countries without border countries
        - of malta
        """
        # run tool for country
        self.run_wahoomapscreator_cli('133','75')

    def test_calc_output_germany_tile_wrong_render(self):
        """
        Test output of countries without border countries
        - of malta
        """
        # run tool for country
        self.run_wahoomapscreator_cli('132','85')

        # compare generated given merged.osm.pbf-file with reference-file
#        self.compare_dir_sub_test_resource_and_output('138', 'malta')
#        self.compare_dir_sub_test_resource_and_output('137', 'malta')

    def run_wahoomapscreator_cli(self, tileX, tileY):
        """
        ...
        result = os.system(
            f'python -m wahoomc cli -xy {tileX}/{tileY} -tag tag-wahoo.xml -fp -c -md 9999 -nbc')
